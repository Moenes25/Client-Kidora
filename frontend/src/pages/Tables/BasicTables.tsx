...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="Parents • KI DORA"
        description="Gestion créative des parents avec filtres, recherche et actions rapides"
      />
      ...
      <div className="relative mb-6 overflow-hidden rounded-2xl border border-indigo-200/40 bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 p-6 text-white shadow">
        ...
        <div className="relative z-10">
          <h1 className="text-xl font-extrabold tracking-tight">Gestion des parents</h1>
