    ...
    <header className="sticky top-0 flex w-full bg-gradient-to-br from-indigo-500 to-purple-600 border-white/20 z-99999 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-white/20 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-white/90 border-white/30 rounded-lg z-99999 lg:flex lg:h-11 lg:w-11 lg:border hover:bg-white/10"
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none bg-gradient-to-br from-indigo-500 to-purple-600`}
        >
