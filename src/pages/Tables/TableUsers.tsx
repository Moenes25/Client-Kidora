...
export default function TableUsers() {
  return (
    <>
      <PageMeta
        title="Utilisateurs • KI DORA"
        description="Gestion créative des utilisateurs avec filtres, sélection multiple et actions rapides"
      />
      ...
      <div className="relative mb-6 overflow-hidden rounded-2xl border border-indigo-200/40 bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 p-6 text-white shadow">
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            <h1 className="text-xl font-extrabold tracking-tight">Gestion des utilisateurs</h1>
