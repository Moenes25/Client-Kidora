...
const activities = [
  {
    ...
    type: "observation",
    icon: <UserIcon className="size-5 text-blue-600" />,
  ...
  },
  {
    ...
    type: "apprentissage",
    icon: <ChatIcon  className="size-5 text-purple-600" />,
  ...
  },
  {
    ...
    type: "absence",
    icon: <TimeIcon className="size-5 text-amber-600" />,
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900 shadow-sm">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
        <button className="w-full py-2.5 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-sm font-medium">
